...
const projects = [
  {
    ...
    description:
      "Modern barbershop website with online booking system and service showcase",
  ...
  },
  {
    ...
    title: "p2p Platform",
    description:
      "Secure peer-to-peer cryptocurrency trading platform with escrow services",
  ...
  },
  {
    ...
    description:
      "Professional video editing service landing page with portfolio showcase",
    stack: [
      { name: "React" },
      { name: "JavaScript" },
      { name: "Tailwind CSS" },
  ...
  },
  {
    ...
    title: "Movie App",
    description:
      "Interactive movie discovery app with ratings, reviews, and watchlist features",
    stack: [{ name: "Next.js" }, { name: "Tailwind CSS" }],
